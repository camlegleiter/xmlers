...
public class Form {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = {
        "textQuestionOrVariadicBooleanQuestion"
    })
    public static class Questions {
        ...
        protected List<Question> textQuestionOrVariadicBooleanQuestion;

        /**
         * Gets the value of the textQuestionOrVariadicBooleanQuestion property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the textQuestionOrVariadicBooleanQuestion property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getTextQuestionOrVariadicBooleanQuestion().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<Question> getTextQuestionOrVariadicBooleanQuestion() {
            if (textQuestionOrVariadicBooleanQuestion == null) {
                textQuestionOrVariadicBooleanQuestion = new ArrayList<Question>();
            }
            return this.textQuestionOrVariadicBooleanQuestion;
        }
